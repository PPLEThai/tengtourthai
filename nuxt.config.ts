  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { property: 'og:image', content: 'https://tengtourthai.vercel.app/images/thumbnail-teng.png' }, // Path to your thumbnail image
        ...
        { property: 'og:url', content: 'https://tengtourthai.vercel.app' } // Replace with your actual URL
      ],
      link: [
