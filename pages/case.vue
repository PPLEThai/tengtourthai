<template>
  <section class="max-w-7xl mx-auto px-4 py-8 md:py-10 text-secondary">
    <div class="rounded-3xl bg-gradient-primary text-white shadow-md p-6 md:p-8">
      <h1 class="text-2xl md:text-4xl font-heading font-medium">แดชบอร์ดเคสขับเคลื่อนจากพื้นที่</h1>
    ...
    <div class="mt-6 grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
      <div class="rounded-2xl bg-white border border-black/5 shadow-sm p-4">
        <p class="text-sm text-muted-foreground">เรื่องร้องเรียนทั้งหมด</p>
        <p class="text-3xl font-bold mt-2 text-primary">3,286</p>
        <p class="text-xs text-muted-foreground mt-1">สะสมตั้งแต่เปิดระบบ</p>
      </div>
      <div class="rounded-2xl bg-white border border-black/5 shadow-sm p-4">
        <p class="text-sm text-muted-foreground">เคสที่เปิดรับ</p>
        <p class="text-3xl font-bold mt-2 text-[#ff6900]">842</p>
        <p class="text-xs text-[#ff6900]/90 mt-1">กำลังดำเนินการ</p>
      </div>
      <div class="rounded-2xl bg-white border border-black/5 shadow-sm p-4">
        <p class="text-sm text-muted-foreground">เคสที่ปิดได้</p>
        <p class="text-3xl font-bold mt-2">2,444</p>
        <p class="text-xs text-[#ff6900] mt-1">อัตราปิดเคส 74.4%</p>
      </div>
      <div class="rounded-2xl bg-white border border-black/5 shadow-sm p-4">
        <p class="text-sm text-muted-foreground">เวลาปิดเคสเฉลี่ย</p>
